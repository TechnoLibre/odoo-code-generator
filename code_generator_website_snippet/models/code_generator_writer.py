...
class CodeGeneratorWriter(models.Model):
    ...
    def set_xml_views_file(self, module):
        ...
        for s_snippet in lst_snippet:
            ...
            if module.enable_generate_website_snippet_javascript:
                s_class_extra = (
                    "text-center " if module.generate_website_snippet_type != "content" else ""
                )
            ...
            if module.generate_website_snippet_type == "structure":
                e_section = E.section(
                    ...
                    E.div({"class": "container"}, E.div({"class": "row mt16 mb16"}, s_value)),
                )
            elif module.generate_website_snippet_type == "feature":
                e_section = E.section(
                    {"class": f"{xml_id_class}"}, E.div({"class": "container"}, s_value)
                )
        ...
        s_option_comment = (
            " and Javascript" if module.enable_generate_website_snippet_javascript else ""
        )
